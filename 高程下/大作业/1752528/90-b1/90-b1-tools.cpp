...
void compound(char W[12][12], int N[12][12], char xh, int a, int b, char choose, int a1, int b1, int & score, int & max)         //完成一次合成  ab为行列数 a1 b1为目标数 goal为合成目标
{
	int t;
	int xc = 0;
	max = 3;                                           //记录合成后最大值
